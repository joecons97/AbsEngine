...
namespace AbsGameProject.Systems.Terrain
{
    ...
    public class TerrainMeshConstructorSystem : ComponentSystem<TerrainChunkComponent>
    {
        ...
        static Queue<TerrainChunkComponent> _chunksToConstruct = new Queue<TerrainChunkComponent>();
        ...
        void ConstructChunkQueueThreaded()
        {
            ...
            {
                TerrainChunkComponent? component;
                lock (_chunksToConstruct)
                {
                    if (_chunksToConstruct.TryDequeue(out component) == false)
                        continue;
                }
